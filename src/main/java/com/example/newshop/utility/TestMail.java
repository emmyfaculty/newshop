package com.example.newshop.utility;
...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "aholemmy@gmail.com";
			...
			String htmlTextMessage = ""
					...
					+ "<p>Hey,<br>"
					+ "Thanks for singing up with Emason Electronics.<br>"
					...
					+ "<span class='greenText'>EMASON500</span><br><br>"
					+ "Have a good day!<br>"
					+ "</p>"
					+ "</body>"
					+ "</html>";

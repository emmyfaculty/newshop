...
<%@ page import="com.example.newshop.dao.*,com.example.newshop.beans.*,java.util.*,javax.servlet.ServletOutputStream,java.io.*" %>
...
<div class="row text-center">
  ...
  <div class="col-sm-4">
    <div class="thumbnail">
      ...
      <p class="price">#s <%=product.getProdPrice() %> </p>
      <form method="post">
